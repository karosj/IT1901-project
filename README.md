[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.stack.it.ntnu.no/#https://gitlab.stud.idi.ntnu.no/it1901/todo-list) 
